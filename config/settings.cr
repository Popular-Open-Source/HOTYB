...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Hotyb web application."
  #
  #
  ...
  #
  # settings.secret_key_base= q5MFBCn4zqT324j0Fa_DdIYrH_7ZCYcHKOrLI_LsBC8
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("hotyb.log", "w"))
  #
  #
end
